...
- (Optional) OpenAI account for AI brand personality
...
4. **Verify**
   - Enter a public website URL on the homepage → should go to /analyze and show extraction.
...
3. **Environment variables**
   - Project → Settings → Environment Variables:
     ...
     - `OPENAI_API_KEY` = optional, for AI brand analysis.
