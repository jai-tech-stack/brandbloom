        ...
        <div className="mx-auto max-w-5xl px-4 pt-24 pb-24">
          {demoMode && (
            <div className="mb-6 rounded-xl border border-amber-500/50 bg-amber-500/10 px-4 py-3 text-sm text-amber-200">
              Demo mode — configure EMERGENT_LLM_KEY for real AI images.
            </div>
          )}
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {assets.map((asset) => (
              <div
                key={asset.id}
                className="group overflow-hidden rounded-xl border border-surface-600 bg-surface-800/50 transition hover:border-brand-500/50"
              >
                <div className="aspect-square w-full bg-surface-700 relative overflow-hidden">
                  <img src={asset.url} alt={asset.label} className="h-full w-full object-cover transition group-hover:scale-105" />
